...
function I(n3, l4, u5, t4, i5, r4, o4, e4, f5, c4, s4) {
  var a4, h5, y5, w5, d4, g4, _5, m4 = t4 && t4.__k || v, b4 = l4.length;
  for (f5 = P(u5, l4, m4, f5, b4), a4 = 0; a4 < b4; a4++) null != (y5 = u5.__k[a4]) && (h5 = -1 == y5.__i ? p : m4[y5.__i] || p, y5.__i = a4, g4 = O(n3, y5, h5, i5, r4, o4, e4, f5, c4, s4), w5 = y5.__e, y5.ref && h5.ref != y5.ref && (h5.ref && B(h5.ref, null, y5), s4.push(y5.ref, y5.__c || w5, y5)), null == d4 && null != w5 && (d4 = w5), (_5 = !!(4 & y5.__u)) || h5.__k === y5.__k ? f5 = A(y5, f5, n3, _5) : "function" == typeof y5.type && void 0 !== g4 ? f5 = g4 : w5 && (f5 = w5.nextSibling), y5.__u &= -7);
  return u5.__e = d4, f5;
}
...
function O(n3, u5, t4, i5, r4, o4, e4, f5, c4, s4) {
  var a4, h5, p5, v4, y5, _5, m4, b4, S2, C4, M2, $2, P3, A4, H2, L2, T3, j3 = u5.type;
  if (null != u5.constructor) return null;
  128 & t4.__u && (c4 = !!(32 & t4.__u), o4 = [f5 = u5.__e = t4.__e]), (a4 = l.__b) && a4(u5);
  n: if ("function" == typeof j3) try {
    if (b4 = u5.props, S2 = "prototype" in j3 && j3.prototype.render, C4 = (a4 = j3.contextType) && i5[a4.__c], M2 = a4 ? C4 ? C4.props.value : a4.__ : i5, t4.__c ? m4 = (h5 = u5.__c = t4.__c).__ = h5.__E : (S2 ? u5.__c = h5 = new j3(b4, M2) : (u5.__c = h5 = new x(b4, M2), h5.constructor = j3, h5.render = E), C4 && C4.sub(h5), h5.props = b4, h5.state || (h5.state = {}), h5.context = M2, h5.__n = i5, p5 = h5.__d = true, h5.__h = [], h5._sb = []), S2 && null == h5.__s && (h5.__s = h5.state), S2 && null != j3.getDerivedStateFromProps && (h5.__s == h5.state && (h5.__s = d({}, h5.__s)), d(h5.__s, j3.getDerivedStateFromProps(b4, h5.__s))), v4 = h5.props, y5 = h5.state, h5.__v = u5, p5) S2 && null == j3.getDerivedStateFromProps && null != h5.componentWillMount && h5.componentWillMount(), S2 && null != h5.componentDidMount && h5.__h.push(h5.componentDidMount);
    else {
      if (S2 && null == j3.getDerivedStateFromProps && b4 !== v4 && null != h5.componentWillReceiveProps && h5.componentWillReceiveProps(b4, M2), !h5.__e && null != h5.shouldComponentUpdate && false === h5.shouldComponentUpdate(b4, h5.__s, M2) || u5.__v == t4.__v) {
    ...
    if (h5.context = M2, h5.props = b4, h5.__P = n3, h5.__e = false, P3 = l.__r, A4 = 0, S2) {
      for (h5.state = h5.__s, h5.__d = false, P3 && P3(u5), a4 = h5.render(h5.props, h5.state, h5.context), H2 = 0; H2 < h5._sb.length; H2++) h5.__h.push(h5._sb[H2]);
      h5._sb = [];
    } else do {
      h5.__d = false, P3 && P3(u5), a4 = h5.render(h5.props, h5.state, h5.context), h5.state = h5.__s;
    } while (h5.__d && ++A4 < 25);
    h5.state = h5.__s, null != h5.getChildContext && (i5 = d(d({}, i5), h5.getChildContext())), S2 && !p5 && null != h5.getSnapshotBeforeUpdate && (_5 = h5.getSnapshotBeforeUpdate(v4, y5)), L2 = a4, null != a4 && a4.type === k && null == a4.key && (L2 = V(a4.props.children)), f5 = I(n3, w(L2) ? L2 : [L2], u5, t4, i5, r4, o4, e4, f5, c4, s4), h5.base = u5.__e, u5.__u &= -161, h5.__h.length && e4.push(h5), m4 && (h5.__E = h5.__ = null);
  } catch (n4) {
...
function q(u5, t4, i5, r4, o4, e4, f5, c4, s4) {
  var a4, h5, v4, y5, d4, _5, m4, b4 = i5.props, k3 = t4.props, x4 = t4.type;
  ...
  if (null == x4) b4 === k3 || c4 && u5.data == k3 || (u5.data = k3);
  else {
    if (e4 = e4 && n.call(u5.childNodes), b4 = i5.props || p, !c4 && null != e4) for (b4 = {}, a4 = 0; a4 < u5.attributes.length; a4++) b4[(d4 = u5.attributes[a4]).name] = d4.value;
    ...
    for (a4 in k3) d4 = k3[a4], "children" == a4 ? y5 = d4 : "dangerouslySetInnerHTML" == a4 ? h5 = d4 : "value" == a4 ? _5 = d4 : "checked" == a4 ? m4 = d4 : c4 && "function" != typeof d4 || b4[a4] === d4 || j(u5, a4, d4, b4[a4], o4);
    if (h5) c4 || v4 && (h5.__html == v4.__html || h5.__html == u5.innerHTML) || (u5.innerHTML = h5.__html), t4.__k = [];
    else if (v4 && (u5.innerHTML = ""), I("template" == t4.type ? u5.content : u5, w(y5) ? y5 : [y5], t4, i5, r4, "foreignObject" == x4 ? "http://www.w3.org/1999/xhtml" : o4, e4, f5, e4 ? e4[0] : i5.__k && S(i5, 0), c4, s4), null != e4) for (a4 = e4.length; a4--; ) g(e4[a4]);
    c4 || (a4 = "value", "progress" == x4 && null == _5 ? u5.removeAttribute("value") : null != _5 && (_5 !== u5[a4] || "progress" == x4 && !_5 || "option" == x4 && _5 != b4[a4]) && j(u5, a4, _5, b4[a4], o4), a4 = "checked", null != m4 && m4 != u5[a4] && j(u5, a4, m4, b4[a4], o4));
  }
  return u5;
}
function B(n3, u5, t4) {
...
function LocationProvider(props) {
  const [url, route] = h2(handleNav, props.url || location.pathname + location.search);
...
function Router(props) {
  ...
  prev.current = null;
  this.__c = (e4, suspendedVNode) => {
    didSuspend.current = true;
    prev.current = p5;
    if (props.onLoadStart) props.onLoadStart(url);
    isLoading.current = true;
    let c5 = count.current;
    e4.then(() => {
      if (c5 !== count.current) return;
      prev.current = null;
      if (cur.current) {
...
// node_modules/.pnpm/preact-iso@2.11.0_preact-render-to-string@6.6.2_preact@10.27.1__preact@10.27.1/node_modules/preact-iso/src/lazy.js
init_preact_module();
var oldDiff = l.__b;
l.__b = (vnode) => {
...
// node_modules/.pnpm/preact-iso@2.11.0_preact-render-to-string@6.6.2_preact@10.27.1__preact@10.27.1/node_modules/preact-iso/src/hydrate.js
init_preact_module();

// node_modules/.pnpm/@retroachievements+api@https+++codeload.github.com+monkey-bug+retroachievements-api-js+_665f150758de036fa276ad3dadbe21e4/node_modules/@retroachievements/api/dist/api.modern.js
var A3;
var I2;
var P2;
!(function(e4) {
  e4[e4.NewSet = 0] = "NewSet", e4[e4.Revision = 1] = "Revision";
})(A3 || (A3 = {})), (function(e4) {
  e4[e4.Active = 0] = "Active", e4[e4.Complete = 1] = "Complete", e4[e4.Dropped = 2] = "Dropped";
})(I2 || (I2 = {})), (function(e4) {
  e4[e4.Primary = 0] = "Primary", e4[e4.Collaboration = 1] = "Collaboration";
})(P2 || (P2 = {}));
var b;
var C3;
!(function(e4) {
  e4[e4.CoreAchievements = 3] = "CoreAchievements", e4[e4.UnofficialAchievements = 5] = "UnofficialAchievements";
})(b || (b = {})), (function(e4) {
  e4.Primary = "0", e4.Collaboration = "1";
})(C3 || (C3 = {}));

// node_modules/.pnpm/@preact+signals@2.3.1_preact@10.27.1/node_modules/@preact/signals/dist/signals.module.js
init_preact_module();
...
function F2() {
  if (1 === m3.push(this)) (l.requestAnimationFrame || q2)(x3);
}

// src/components/tabarea.jsx
init_preact_module();

// src/components/tabarea.module.css
var bar = "tabarea_bar";
var tab = "tabarea_tab";
var active = "tabarea_active";
var content = "tabarea_content";
...
function u4(e4, t4, n3, o4, i5, u5) {
  ...
  var l4 = { type: e4, props: p5, key: n3, ref: a4, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --f4, __i: -1, __u: 0, __source: i5, __self: u5 };
  if ("function" == typeof e4 && (a4 = e4.defaultProps)) for (c4 in a4) void 0 === p5[c4] && (p5[c4] = a4[c4]);
  return l.vnode && l.vnode(l4), l4;
}

// src/components/tabarea.jsx
var TabArea = class _TabArea extends x {
  ...
  render({ children, ...props }, state) {
    const tabs = children.filter((v4) => v4.type == _TabArea.Tab).map((v4, i5) => [i5, v4]);
    const content2 = tabs.map((v4) => [v4[0], v4[1].props.children]);
    return /* @__PURE__ */ u4("div", { class: props.class, children: [
      /* @__PURE__ */ u4("div", { class: bar, children: tabs.map((tab2) => /* @__PURE__ */ u4(
        "button",
        {
          onClick: () => this.setState({ activeTab: tab2[0] }),
          class: `${tab} ${tab2[0] == state.activeTab ? active : ""}`,
          children: tab2[1]
        },
        tab2[0]
      )) }),
      /* @__PURE__ */ u4("div", { class: content, children: content2.map((content3) => /* @__PURE__ */ u4("div", { class: content3[0] == state.activeTab ? active : "", children: content3[1] }, content3[0])) })
    ] });
  }
};

// src/tools/verify.module.css
var main = "verify_main";
var sidebar = "verify_sidebar";
var tabarea = "verify_tabarea";
var buttons = "verify_buttons";
var submission = "verify_submission";
var output = "verify_output";

// src/tools/verify.jsx
...
function OutputPane({ data }) {
  return /* @__PURE__ */ u4("div", { class: output, children: data.value.foo });
}
function Verify() {
  const submission2 = useSignal("");
  const data = useSignal({});
  const tabArea = A2(null);
  const username = useSignal("");
  const alt = useSignal("");
  const startDate = useSignal(/* @__PURE__ */ new Date(0));
  ...
  const verify = () => {
    data.value = { foo: parseInt(submission2.value) };
    tabArea.current.setActiveTab(1);
  };
  return /* @__PURE__ */ u4("div", { class: main, children: [
    /* @__PURE__ */ u4("div", { class: sidebar, children: [
    ...
    /* @__PURE__ */ u4(TabArea, { class: tabarea, ref: tabArea, children: [
      /* @__PURE__ */ u4(TabArea.Tab, { name: "Submission", children: /* @__PURE__ */ u4(SubmissionPane, { text: submission2 }) }),
      /* @__PURE__ */ u4(TabArea.Tab, { name: "Output", children: /* @__PURE__ */ u4(OutputPane, { data }) })
    ] }),
    /* @__PURE__ */ u4("div", { class: buttons, children: [
      /* @__PURE__ */ u4("button", { onClick: clear, children: "Clear" }),
      /* @__PURE__ */ u4("button", { onClick: verify, children: "Verify" })
    ] }),
    /* @__PURE__ */ u4("div", { id: "options", style: "display:none", children: [
      /* @__PURE__ */ u4("button", { id: "optionExportURL", children: "Export to URL" }),
      /* @__PURE__ */ u4("button", { id: "optionResetAuth", children: "Reset Auth" }),
      /* @__PURE__ */ u4("select", { id: "optionDateFormat", children: [
        /* @__PURE__ */ u4("option", { children: "yyyy-mm-dd" }),
        /* @__PURE__ */ u4("option", { children: "mm/dd/yyyy" }),
        /* @__PURE__ */ u4("option", { children: "dd/mm/yyyy" }),
        /* @__PURE__ */ u4("option", { children: "mm-dd-yyyy" }),
        /* @__PURE__ */ u4("option", { children: "dd-mm-yyyy" })
      ] }),
      /* @__PURE__ */ u4("label", { children: [
        /* @__PURE__ */ u4("input", { id: "optionCheckDate", type: "checkbox", checked: true }),
        "Check date"
      ] })
    ] }),
    /* @__PURE__ */ u4("template", { id: "authModalTemplate", children: /* @__PURE__ */ u4("div", { class: "authModal", children: /* @__PURE__ */ u4("div", { children: [
      /* @__PURE__ */ u4("label", { children: "Username:" }),
      /* @__PURE__ */ u4("input", { name: "username", type: "text" }),
      /* @__PURE__ */ u4("label", { children: "API Key:" }),
      /* @__PURE__ */ u4("input", { name: "apikey", type: "password" }),
      /* @__PURE__ */ u4("label", { children: [
        /* @__PURE__ */ u4("input", { name: "saveinfo", type: "checkbox" }),
        "Save Info"
      ] }),
      /* @__PURE__ */ u4("button", { children: "Ok" })
    ] }) }) })
  ] });
}
...
var openbutton = "menu_openbutton";
...
var icons = {
  ...
  gear: /* @__PURE__ */ u4("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", fill: "currentColor", class: "bi bi-gear-fill", viewBox: "0 0 16 16", children: /* @__PURE__ */ u4("path", { d: "M9.405 1.05c-.413-1.4-2.397-1.4-2.81 0l-.1.34a1.464 1.464 0 0 1-2.105.872l-.31-.17c-1.283-.698-2.686.705-1.987 1.987l.169.311c.446.82.023 1.841-.872 2.105l-.34.1c-1.4.413-1.4 2.397 0 2.81l.34.1a1.464 1.464 0 0 1 .872 2.105l-.17.31c-.698 1.283.705 2.686 1.987 1.987l.311-.169a1.464 1.464 0 0 1 2.105.872l.1.34c.413 1.4 2.397 1.4 2.81 0l.1-.34a1.464 1.464 0 0 1 2.105-.872l.31.17c1.283.698 2.686-.705 1.987-1.987l-.169-.311a1.464 1.464 0 0 1 .872-2.105l.34-.1c1.4-.413 1.4-2.397 0-2.81l-.34-.1a1.464 1.464 0 0 1-.872-2.105l.17-.31c.698-1.283-.705-2.686-1.987-1.987l-.311.169a1.464 1.464 0 0 1-2.105-.872zM8 10.93a2.929 2.929 0 1 1 0-5.86 2.929 2.929 0 0 1 0 5.858z" }) })
};
function MenuButton(props) {
  return /* @__PURE__ */ u4("div", { class: openclose, children: [
    _("button", { "class": openbutton, ...props }, icons.list),
...
function Menu() {
  const container2 = A2(null);
  const toggleMenu = () => {
    container2.current.classList.toggle(open);
  };
  return /* @__PURE__ */ u4("div", { class: container, ref: container2, children: [
    /* @__PURE__ */ u4(MenuButton, { onClick: toggleMenu }),
    /* @__PURE__ */ u4(MenuItems, {})
  ] });
}
